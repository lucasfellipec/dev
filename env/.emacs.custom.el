(custom-set-variables
 ...
 '(package-selected-packages
   '(ag clojure-mode cmake-mode d-mode dash-functional
        docker-compose-mode dockerfile-mode elpy glsl-mode go-mode
        graphviz-dot-mode gruber-darker-theme ido-completing-read+
        jinja2-mode kotlin-mode lsp-docker lua-mode markdown-mode
        move-text multiple-cursors nginx-mode nim-mode nix-mode
        php-mode purescript-mode qml-mode racket-mode rfc-mode
        rust-mode scala-mode smex sml-mode toml-mode tuareg
